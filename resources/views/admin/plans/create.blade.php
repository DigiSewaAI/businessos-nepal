            ...
            <form action="{{ route('admin.plans.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('duration_months') is-invalid @enderror" id="duration_months" name="duration_months" value="{{ old('duration_months') }}" min="1" max="60" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_products') is-invalid @enderror" id="max_products" name="max_products" value="{{ old('max_products', 0) }}" min="0" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_branches') is-invalid @enderror" id="max_branches" name="max_branches" value="{{ old('max_branches', 1) }}" min="1" required>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('features') is-invalid @enderror" id="features" name="features" rows="3" placeholder='{"feature1": "value", "feature2": "value"}'></textarea>
                        @error('features') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <small class="text-muted">Enter valid JSON array or object. e.g. {"inventory": true, "pos": true}</small>
                    </div>
                    <div class="col-12">
