    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Update page content</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.cms.update', $page->id) }}" method="POST">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" name="meta_description" rows="2"
                                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition @error('meta_description') border-red-500 @enderror">{{ old('meta_description', $page->meta_description) }}</textarea>
                ...
                <div class="px-6 py-4 bg-gray-50/80 border-t border-gray-200 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white text-sm font-medium rounded-lg shadow-lg shadow-amber-200 transition-all hover:shadow-xl">
                        <i class="fa-solid fa-check mr-1.5"></i> Update Page
                    </button>
                </div>
            </form>
        </div>
