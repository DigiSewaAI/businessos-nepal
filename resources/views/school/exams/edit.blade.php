...
<div class="pt-24 pb-12 px-4 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Edit Exam: {{ $exam->name }}</h1>
        </div>
            ...
            <form action="{{ route('school.exams.update', $exam) }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="start_date" value="{{ old('start_date', $exam->start_date->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="end_date" value="{{ old('end_date', $exam->end_date->format('Y-m-d')) }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_marks" value="{{ old('max_marks', $exam->max_marks) }}"
                    ...
                    <div>
                        ...
                        <textarea name="description" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" rows="3">{{ old('description', $exam->description) }}</textarea>
                    </div>
                ...
                <div class="mt-8 flex justify-end space-x-3 border-t border-gray-200 pt-6">
                    ...
                    <button type="submit" class="gradient-bg text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90">
                        <i class="fa-solid fa-save"></i> Update Exam
                    </button>
                </div>
            </form>
        </div>
